...
remove_button = customtkinter.CTkButton(app,command=remove_task,font=font2,text_color="#fff",text="Remove Task",fg_color='#96061c',bg_color="#09112e",cursor="hand2",corner_radius=5)
